    ...
    const [pastOrders, setPastOrders] = useState<PastOrder[]>([
        {
            ...
            status: 'Delivered',
            items: [
                { id: 1, name: 'Chocolate Chip', price: 2.5, quantity: 4, image: '/chocolate-chip.png' },
                { id: 3, name: 'Nutella Loaded Coissant', price: 1.5, quantity: 4, image: '/nutella-croissant.png' }
            ]
        },
        {
            id: 'ORD-2023-002',
            ...
            status: 'Shipped',
            items: [
                { id: 2, name: 'Sugar Cookie', price: 3.0, quantity: 3, image: '/sugar-cookie.png' }
            ]
        }
    ]);
